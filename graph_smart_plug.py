...
#
#        """
#        time_data, inst_pw_data, total_power_data,    = self._prep_data( db_device_adapter.name,  db_start, db_end, min_points  )
...
#        plt.show()
    ...
    # ---------------old not think worked, but will not now as call changed ------------------------
...
#         .
#        """
#        time_data, inst_pw_data, total_power_data,    = self._prep_data( db_device_adapter,   db_start, db_end, min_points  )
#        if time_data is None:
#            return
#
#        min_time_data     = time_data[0]
